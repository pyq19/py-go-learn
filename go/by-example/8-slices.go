...
func main() {
    ...
    they contain (not the number of elements). To create an empty
    ...
    // len: 3
    // `len` returns the length of the slice as expected(预期的).
    ...
    // `slice[low:high]`. e.g. this gets a slice of the elements
    // s[2], s[3], and s[4].
...
/* Note that while slices are different types than arrays,
   ...
   MORE DETAIL -> https://blog.golang.org/go-slices-usage-and-internals
*/
