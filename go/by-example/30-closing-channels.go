// Closing a channel indicates(表明,指示) that no more values will be
...
work to be done from the `main()` goroutine to a worker goroutine.
...
all values in the channel have already been received. We use this to 
