#coding:utf8
# https://github.com/RafeKettler/magicmethods/blob/master/magicmethods.py
...
# Word class, demonstrating __new__, comparisons(比较)
class Word(str):
    ...
    def __new__(cls, word):
        ...
        if ' ' in word:
            print 'Value contains spaces, Truncating(截断) to first space.'
...
class Distance(object):
    """Class to represent distance holding two desciptors for feet and 
    meters."""
    meter = Meter()
    foot = Foot()
...
class Slate:
    """Class to store a string and changelog, and forget its value when pickled."""
